🚗 FleetCard — Gist do Projeto

O que é: Sistema de gestão e cadastro de veículos em Django (Atividade Avaliativa, Grupo 3: Raphael Farias, Kayke Cansanção, Letícia, Fabiano).

🧩 Núcleo funcional
CRUD completo de Veículos e de Ordens de Serviço (1 veículo → N ordens)
Formulário de Contato persistido no banco
Autenticação + Django Admin personalizado
Página de veículos integrada com API própria
Interface responsiva (Bootstrap)
🛠️ Stack

Python 3.13.13 · Django 6.1.1 · SQLite · Bootstrap 5.3.3 + Bootstrap Icons · Git/GitHub
...
#8A2A22 + dourado 
#BE770D, fundo bege 
#FBF1E0, cards brancos, border-radius: 0.75rem, hover/gradiente na navbar e footer.

🗄️ Modelos
Veiculo → tipo, marca, modelo, placa (única), ano, cor, combustível, km, observações, imagem
OrdemServico → FK para Veiculo
Contato → nome, e-mail, telefone, assunto, mensagem
🔄 Rotas principais

/veiculos/ · /ordens-servico/ · /veiculos/<id>/ordens-servico/ · /contatos/ · /pagina_veiculos/ · /admin/

📊 Status

Tudo entregue: CRUDs, relacionamento, contato, autenticação, admin custom, API, responsividade, versionamento — projeto concluído.

Quer que eu trate isso como a versão final/atualizada do FleetCard na memória, ou você vai colar mais alguma parte do documento?

quero complet em gist
...
Cor	Hex	Utilização
🔴 Primária	
#8A2A22	Botões, navbar e destaques
🟥 Primária escura	
#6B1E18	Hover e gradientes
🟡 Dourado	
#BE770D	Destaques secundários
🟤 Texto	
#2E1B12	Textos principais
🟫 Texto suave	
#6B5544	Textos secundários
🟨 Fundo	
#FBF1E0	Fundo da página
⚪ Fundo Card	
#FFFFFF	Cards e formulários
❌ Danger	
#A5342A	Exclusões e erros
✅ Success	
#3E7A44	Confirmações
ℹ️ Info	
#2E6F73	Informações
